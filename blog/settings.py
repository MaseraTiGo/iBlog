...
SECRET_KEY = 'e#ywuv(b@soz+c*j-+z1+k8apo6--d0=muiium%tf_m@_-xbgn'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1','111.229.151.233','www.binbio.club']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'iblog',    # 请换成新建的数据库
        'USER': 'root',
        'PASSWORD': 'iBlog*1212',  # 请换成自己的密码
...
# # 分页器
PAGINATION_SETTINGS = {
    'PAGE_RANGE_DISPLAYED': 2,   # 中间显示多少个页码
